...
export const HyperappIcon: React.FC<SVGIconProps> = ({ ...props }) => (
  <Shell {...props}>
    <path
...
export const HyperappIconDark: React.FC<SVGIconProps> = ({ ...props }) => (
  <Shell {...props}>
    <path
      d="M31 8V24C31 26.21 29.21 28 27 28H5C2.79 28 1 26.21 1 24V8C1 5.79 2.79 4 5 4H27C29.21 4 31 5.79 31 8Z"
      fill="white"
...
export const HyperappIconLight: React.FC<SVGIconProps> = ({ ...props }) => (
  <Shell {...props}>
    <path
      d="M31 8V24C31 26.21 29.21 28 27 28H5C2.79 28 1 26.21 1 24V8C1 5.79 2.79 4 5 4H27C29.21 4 31 5.79 31 8Z"
      fill="black"
