...
export const AdonisIcon: FunctionComponent<ComponentProps<typeof SVGIcon>> = ({
  ...props
}) => (
  <SVGIcon {...props}>
    <path
...
export const AdonisIconDark: FunctionComponent<
...
export const AdonisIconLight: FunctionComponent<
  ComponentProps<typeof SVGIcon>
> = ({ ...props }) => (
  <SVGIcon {...props}>
    <path
