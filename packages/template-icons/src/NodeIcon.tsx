...
export const NodeIcon: FunctionComponent<ComponentProps<typeof SVGIcon>> = ({
  ...props
}) => {
...
export const NodeIconDark: FunctionComponent<
...
export const NodeIconLight: FunctionComponent<
  ComponentProps<typeof SVGIcon>
> = ({ ...props }) => (
  <SVGIcon {...props}>
    <path
