...
export const NodeIcon: React.FC<SVGIconProps> = ({
  scale = 1,
  width = 32,
  height = 32,
  ...props
  ...
  >
    <g clipPath="url(#Node_Clip0)">
      ...
      <path
        ...
        fill="url(#Node_Paint2_Linear)"
      />
      <path
        d="M30.5002 24.32L30.4171 24.1779V24.3681L30.5002 24.32Z"
        fill="url(#Node_Paint3_Linear)"
      />
    </g>
    <defs>
      <linearGradient
        id="Node_Paint0_Linear"
        x1="21.0998"
        y1="5.59334"
        x2="9.76805"
        y2="28.71"
