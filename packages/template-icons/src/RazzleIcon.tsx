...
export const RazzleIcon: FunctionComponent<ComponentProps<typeof SVGIcon>> = ({
  ...props
}) => {
...
export const RazzleIconDark: FunctionComponent<
...
export const RazzleIconLight: FunctionComponent<
  ComponentProps<typeof SVGIcon>
> = ({ ...props }) => (
  <SVGIcon {...props}>
    <path
