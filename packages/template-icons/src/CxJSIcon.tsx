...
export const CxJSIcon: FunctionComponent<ComponentProps<typeof SVGIcon>> = ({
  ...props
}) => {
...
export const CxJSIconDark: FunctionComponent<
...
export const CxJSIconLight: FunctionComponent<
  ComponentProps<typeof SVGIcon>
> = ({ ...props }) => (
  <SVGIcon {...props}>
    <path
