...
export const CordovaIcon: React.FC<SVGIconProps> = ({ ...props }) => {
...
export const CordovaIconLight: React.FC<SVGIconProps> = ({ ...props }) => (
  <Shell {...props}>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
...
export const CordovaIconDark: React.FC<SVGIconProps> = ({ ...props }) => (
  <Shell {...props}>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
